...
function NONECOLogo({ size = 64 }: { size?: number }) {
  return (
    <img
      ...
      width={size}
      height={size}
      className="flex-shrink-0 drop-shadow-sm rounded-full ring-1 ring-white/15"
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-stone-900/95 dark:bg-[#0f0e0d]/95 backdrop-blur-sm border-b border-stone-800">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center gap-2.5">
            <img src="/noneco-logo.png" alt="NONECO" className="w-7 h-7 rounded-full object-cover ring-1 ring-white/20" />
